...
Play.prototype = {
    ...
    create: function() {
        ...
        for (var i = 0; i < numOfPots; i++) {
            ...
            potato.body.velocity.y = -(1 - scaleFactor) * 20;
    ...
    render: function() {
        ...
        //
        //     this.game.debug.body(this.child);
        //     this.game.debug.bodyInfo(this.child, 32, 32);
        //
        // });

        // potatoes.forEach(this.game.debug.body, this.game.debug);
    }
};
